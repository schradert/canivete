          ...
          options.kubernetes.helm.releases = mkOption {
            type = attrsOf (submodule {
              options.extraResources = mkOption {
                ...
                description = "Extra resources to attach to Helm release; top-level is plural name, like kubernetes.resources, for optimal merging";
              };
            });
          };
        };
      }
      (mkIf config.canivete.kubenix.enable {
